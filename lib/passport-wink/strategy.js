...
function Strategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || 'https://api.wink.com/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://api.wink.com/oauth2/token';
